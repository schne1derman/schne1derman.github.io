<template>
  <div>
    ...
    <b-row>
      <b-col>
        <b-img thumbnail fluid src="https://www.sacredheart.edu/media/sacredheart/residentiallife/SetonHall-350x231.png" alt="Seton Hall" />
      </b-col>
      <b-col>
        <b-img thumbnail fluid src="https://cdn2.hercampus.com/styles/full_width_embed/s3/ChristianWitnessCommons-350x223.png" alt="Scholars Commons" />
      </b-col>
      <b-col>
        <b-img thumbnail fluid src="https://www.sacredheart.edu/media/sacredheart/residentiallife/Taft-350x194.png" alt="Taft Commons" />
      </b-col>
    </b-row>
  </b-container>
      <br>
